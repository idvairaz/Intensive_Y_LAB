...
public class ProductService {
     ...
     * @throws IllegalArgumentException если товар с таким именем уже существует
    ...
    public Product addProduct(Product product) {
        ...
        try {
            ...
            metricsService.recordOperation("ОШИБКА_ВАЛИДАЦИИ_ТОВАРА", Duration.between(start, LocalDateTime.now()));
            throw e;
        } catch (Exception e) {
     ...
     * Адаптирован для работы с PostgresProductRepository.
     */
    public void printProductStats() {
        System.out.println("\n=== СТАТИСТИКА ТОВАРОВ ===");
        System.out.println("Общая статистика:");
        System.out.println(" - Всего товаров: " + productRepository.getTotalProductsCount());
        System.out.println(" - Категорий: " + productRepository.getTotalCategoriesCount());
        System.out.println(" - Брендов: " + productRepository.getTotalBrandsCount());
    }
}
