...
public class PostgresAuditRepository implements AuditRepository {
    ...
    private final String auditSchema = DatabaseConfig.getAuditSchema();
    ...
    public void save(String username, String action, String details) {
        String sql = "INSERT INTO " + auditSchema + ".logs (id, username, action, details, created_at) VALUES (?, ?, ?, ?, ?)";
    ...
    public List<String> findAll() {
        ...
        String sql = "SELECT username, action, details, created_at FROM " + auditSchema + ".logs ORDER BY created_at DESC";
    ...
    @Override
    public void clear() {
        String sql = "DELETE FROM " + auditSchema + ".logs";
